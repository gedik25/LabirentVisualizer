...
private:
    ...
    void renderPanel(sf::RenderWindow& window, float x, float y, float width, float height);
    void renderText(sf::RenderWindow& window, const std::string& text, float x, float y, 
